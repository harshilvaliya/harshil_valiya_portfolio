  ...
  return (
    ...
    >
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              quality="95"
              priority={true}
              className="h-36 w-36 rounded-full object-cover border-[0.35rem] border-white shadow-xl hover:scale-105 duration-300"
            />
          </motion.div>
      ...
      >
        ...
        <br />
        I'm a<span className="font-bold"> Frontend Web developer.</span> I enjoy
        building sites.
      ...
      >
        ...
        <a
          ...
          href="/Harshil-Valiya-Resume.pdf"
          download
        >
          Download CV
        ...
        <a
          ...
          href="https://github.com/harshilvaliya"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
